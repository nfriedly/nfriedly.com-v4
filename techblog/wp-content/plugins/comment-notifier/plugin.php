...
Description: Let blog visitors to subscribe to comment threads, receiving an email in their mailbox on new comments.
Version: 2.2.6
Author: Stefano Lissa
Author URI: http://www.satollo.net
*/

/*  Copyright 2012  Stefano Lissa  (email : stefano@satollo.net)
