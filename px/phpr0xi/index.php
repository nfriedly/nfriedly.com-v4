...
/*
   ...
   |  Last Modified  | by Ali.Dbg at July 2010                                    |
...
else
{
    ...
    if (!isset($_GET['nf']))
    {
        ...
        $_url_form     = '<script type="text/javascript" src="' . $GLOBALS['_script_base'] . 'pjs.js"></script>' . "\n"
						...
						.'<form method="POST" name="PHProxy" class="pmfclass" target="_top" onsubmit="return PR0XY_G0();">Address :'
						...
						.' <input type="submit" class="pmfclass" value="[Go]" name="go" onclick="PR0XY_G0();"> '
						.'<script>'
