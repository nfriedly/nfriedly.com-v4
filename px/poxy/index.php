...
elseif(isset($_GET['error']) && $_GET['error'] == 'link')
{
	//todo: try to decode the url and 301 the user to the right location. if that fails, show the error page
	show_report(array('which' => 'index', 'category' => 'error', 'group' => 'link'));
}
else
{
...
else
{
    ...
    {
    	$pw_top = file_get_contents('../../../screwbeingsingle.com/pw-top.php');
